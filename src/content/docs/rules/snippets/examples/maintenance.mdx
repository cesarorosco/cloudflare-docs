...
description: Serve a custom maintenance page instead of fetching content from the origin or cache. Ideal for downtime notifications, planned maintenance, or emergency messages.
---
