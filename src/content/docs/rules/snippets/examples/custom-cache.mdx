---
type: example
summary: Control cache programmatically. Use this template to optimise performance and implement custom caching strategies.
goal:
  - Other
operation:
  - Cache
...
title: Custom cache
description: Store, retrieve, and remove assets from cache programmatically. Use this template to optimise performance and implement custom caching strategies.
---
